    ...
    "a": [
        ...
        {"priority": 2, "label": "APAC / International marketing",
         "titles": ["Head of APAC Marketing", "APAC Marketing Director", "VP Marketing APAC",
                    ...
                    "VP International", "General Manager APAC", "Head of Field Marketing APAC",
                    "Regional Marketing Manager APAC"],
         "seniorities": ["c_suite", "vp", "head", "director"],
         "locations": None},
        {"priority": 3, "label": "HQ marketing leader",
         "titles": ["Chief Marketing Officer", "VP Marketing", "Vice President of Marketing",
                    "Head of Marketing", "Head of Demand Generation", "VP Demand Generation",
                    "Director of Field Marketing", "Head of Partner Marketing"],
    ...
    "b": [
        ...
        {"priority": 3, "label": "HQ PR / brand leader",
         "titles": ["Head of PR", "Director of Communications", "VP Communications",
                    ...
                    "Director of Influencer Marketing", "Head of Brand Marketing", "VP Brand",
                    "Head of Community"],
         "seniorities": ["c_suite", "vp", "head", "director"],
         "locations": None},
    ],
